...
public class Sword : MonoBehaviour
{
    ...
    private void Awake()
    {
     ...
     //   activeWeapon = GetComponent<ActiveWeapon>();
        ...
        if (playerController == null) Debug.LogError("PlayerController is NULL on " + gameObject.name);
    
        if (myAnimator == null) Debug.LogError("Animator is NULL on " + gameObject.name);
        if (Camera.main == null) Debug.LogError("Main Camera is NULL in scene!");
    }
